...
import '../constants.dart' as AppConstant;
...
class AppTheme {
  ...
  static const TextStyle categoryText = TextStyle(
      ...
      fontFamily: AppConstant.labelFrontLightItalic
  );
  ...
  static const TextStyle topHeader = TextStyle(
      letterSpacing: 1,
      fontSize: 14,
      color: AppConstant.topHeaderBg,
      fontFamily: AppConstant.labelFrontExtraBold
  );
